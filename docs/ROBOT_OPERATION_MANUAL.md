...
当前完整键位以 [KEYBOARD_CONTROL_TABLE.md](KEYBOARD_CONTROL_TABLE.md) 为准；Quest3 手柄键位见
[QUEST3_VR_CONTROL_TABLE.md](QUEST3_VR_CONTROL_TABLE.md)。
...
| `--ik-speed` | `0.06` | `0.035` | 两台机器人机械臂 | 键盘直接关节控制中前 3 个关节的步进速度参考；参数名为兼容旧接口而保留。 |
...
| --- | --- |
| `TAB` | 切换左臂、右臂、双臂 |
| `I/K` | 当前机械臂第 1 关节正/负方向 |
| `L/J` | 当前机械臂第 2 关节正/负方向 |
| `U/O` | 当前机械臂第 3 关节正/负方向 |
| `T/G` | 当前机械臂第 4 关节正/负方向 |
| `F/H` | 当前机械臂第 5 关节正/负方向 |
| `R/Y` | 当前机械臂第 6 关节正/负方向 |
| `7/8` | 当前机械臂第 7 关节正/负方向 |
| `M/N` | 夹爪开/合 |
